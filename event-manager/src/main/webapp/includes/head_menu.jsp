...
<h1 class="tile-area-title">
	<a href="<%=request.getContextPath()%>/index.jsp" style="color: white;">Gestion de billettrie</a>
</h1>
<div class="tile-area-controls">
    <a onclick="goBackward();" class="square-button bg-transparent fg-white bg-hover-dark no-border"><span class="mif-arrow-left"></span></a>
    <a onclick="goForward();" class="square-button bg-transparent fg-white bg-hover-dark no-border"><span class="mif-arrow-right"></span></a>
